...
export const Icons = {
  ...
  wave: `<svg width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8c0 1.1-.9 2-2 2h0c-1.1 0-2-.9-2-2V4"/><path d="M14 8c0 2.2-1.8 4-4 4"/><path d="M10 12c0 3.3-2.7 6-6 6"/><path d="M14 12c0 3.3 2.7 6 6 6"/><path d="M10 8c0 1.1-.9 2-2 2h0c-1.1 0-2-.9-2-2"/><circle cx="7" cy="20" r="1"/><path d="M6 16l-2 4"/><path d="M18 16l2 4"/></svg>`,
  ...
  sparkle: `<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12 2l2.4 7.2L22 12l-7.6 2.8L12 22l-2.4-7.2L2 12l7.6-2.8z"/></svg>`,
}

// Helper: create a span with inline SVG
